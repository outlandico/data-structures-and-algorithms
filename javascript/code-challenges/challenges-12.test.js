...
const result = transformToLis(obj);
console.log(result);
...
// Example usage:
console.log(count(5, [[1, 3, 5, 7, 9], [5, 5, 5], [1, 2, 3]])); // Output: 4
...
let findMaleAndFemale = (data) => {
  ...
  return maleAndFemaleNames.join(' and ');
};
...
// Example usage:
console.log(findShortest(starWarsData)); // Output: "R2-D2"
