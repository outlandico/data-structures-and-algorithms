...
const updateAnimal = (arr, callback) => {
  // Create a new array to store updated animal strings
  const updatedArray = [];

  // Iterate over the input array and modify each value based on the callback function
  for (let animal of arr) {
    // Apply the callback function to modify the animal string
    const updatedAnimal = callback(animal);
    // Push the updated animal string into the new array
    updatedArray.push(updatedAnimal);
  }

  // Return the new array with updated animal strings
  return updatedArray;
};
...
const sortBackwards = (arr) => {
  // Use the sort method to sort the numbers in descending order
  arr.sort((a, b) => b - a);
  // Return the sorted array
  return arr;
};
...
const sortByPrice = (arr) => {
  // Use the sort method to sort the array of objects by the 'price' property
...
const alphabetizeBetter = (arr) => {
  // Use the localeCompare method to sort the array case-insensitively
...
const sortByLength = (arr) => {
  // Use the sort method to sort the array by string length
...
const sortNumbersByLength = (arr) => {
  // Convert numbers to strings and use the sort method to sort them by string length
...
const sortPeople = (arr) => {
  // Use the sort method to sort the array of objects by the 'lastName' property
...
const sortPeopleBetter = (arr) => {
  ...
  arr.sort((a, b) => {
    ...
    if (lastNameComparison === 0) {
      ...
      // If first names are the same, sort by age (younger one comes first)
...
const sortMeetingsByDay = (arr) => {
  // Create an object to store the order of days of the week
  const daysOrder = {
    'Monday': 1,
    'Tuesday': 2,
    'Wednesday': 3,
  ...
  // Use the sort method to sort the array of objects by the 'dayOfWeek' property
  arr.sort((a, b) => daysOrder[a.dayOfWeek] - daysOrder[b.dayOfWeek]);
  // Return the sorted array
  return arr;
};
...
const sortSchedule = (arr) => {
  // Use the sort method to sort the array of objects by the 'start' property
  arr.sort((a, b) => {
    // If start times are the same, compare end times (shorter meeting comes first)
